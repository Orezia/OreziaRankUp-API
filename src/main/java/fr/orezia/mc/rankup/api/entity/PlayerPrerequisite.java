...
public class PlayerPrerequisite extends AbstractPrerequisite {
  ...
  public @NotNull PlayerPrerequisite id(final @NotNull String id) {
    this.id = id;
    return this;
  }
  ...
  @PublicApi
  @Contract(value = "_ -> this", mutates = "this")
  public @NotNull PlayerPrerequisite playerId(final @NotNull String playerId) {
  ...
  @PublicApi
  @Contract(value = "_ -> this", mutates = "this")
  public @NotNull PlayerPrerequisite query(final @NotNull String query) {
    this.query = query;
    return this;
  }
  ...
  @PublicApi
  @Contract(value = "_ -> this", mutates = "this")
  public @NotNull PlayerPrerequisite action(final @Nullable String action) {
    this.action = action;
    return this;
  }
  ...
  @PublicApi
  @Contract(value = "_ -> this", mutates = "this")
  public @NotNull PlayerPrerequisite title(final @Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  @PublicApi
  @Contract(value = "_ -> this", mutates = "this")
  public @NotNull PlayerPrerequisite lore(final @Nullable String lore) {
    this.lore = lore;
    return this;
  }
  ...
  @PublicApi
  @Contract(value = "_ -> this", mutates = "this")
  public @NotNull PlayerPrerequisite icon(final @Nullable String icon) {
    this.icon = icon;
    return this;
  }
